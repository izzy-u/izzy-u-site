...
export default function Custom404() {
  return (
    ...
    <div className = "bg-card p-8 rounded-lg shadow-xs border border-gray-200">
        ...
        <a href="/izzy-u-site/" className = "text-sm text-glow p-2 m-1 rounded-full border border-blue-400 text-blue-400 hover:bg-primary/10 hover:text-purple-300 hover:border-purple-300 transition-colors duration-300 courier-font"> let's go home. </a>
